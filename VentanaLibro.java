...
public class VentanaLibro extends JFrame {
    ...
    private JPanel panel1; //formulario para capturara libros
    ...
    public VentanaLibro(String title) throws HeadlessException {
        ...
        panel2.setBackground(new Color(187, 231, 143));
        ...
        panel3.setBackground(new Color(174, 169, 225));

        //panel4
        panel4 = new JPanel(new FlowLayout());
        panel4.setBackground(new Color(141, 239, 234));
